...
CREATE INDEX IF NOT EXISTS idx_chat_sessions_project ON chat_sessions(project_id) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_chat_sessions_user ON chat_sessions(user_id) WHERE deleted_at IS NULL;
CREATE INDEX IF NOT EXISTS idx_chat_messages_session ON chat_messages(session_id);
CREATE INDEX IF NOT EXISTS idx_chat_messages_created ON chat_messages(created_at DESC);
CREATE INDEX IF NOT EXISTS idx_ui_components_project ON ui_components(project_id);
CREATE INDEX IF NOT EXISTS idx_ui_components_file ON ui_components(file_path);
